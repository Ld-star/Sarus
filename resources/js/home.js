                ...
                call_api_ajax1('ListReports', 'get', {
                    ...
                    (data) => {
                        ...
                        function CreateAddHeaderRow() {
                            ...
                            $("#btnReportRemove img, #btnReportRemove span").css("top", 3);
                            ...
                            $("#btnReportCreate img, #btnReportCreate span").css("top", 3);
                            ...
                            $("#btnReportCopy img, #btnReportCopy span").css("top", 3);
                            ...
                            $("#btnReportEdit img, #btnReportEdit span").css("top", 3);
                        ...
                        $('#reportBackups .jqx-window-header div').css("float", "none");

                        setTimeout(() => {
                            $('#reportBackups .jqx-window-content').css("width", "calc(100% - 8px)").css("overflow", "unset");
                            $('#reportGrid').css("height", parseInt($("#reportBackups").height()) - 135);
                        ...
                        setTimeout(() => {
                            ...
                            $('#reportBackups .jqx-window-content').css("width", "calc(100% - 8px)").css("overflow", "unset");
                            $("#report-container span").css("left", 28).css("top", 3);
